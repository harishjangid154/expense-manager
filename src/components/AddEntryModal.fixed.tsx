          ...
          <div className="grid grid-cols-[1fr_auto] gap-3">
            ...
            <div className="space-y-2">
              ...
              <Select value={currency} onValueChange={setCurrency}>
                <SelectTrigger className="glass border-[rgba(255,255,255,0.15)] focus:neon-border-blue rounded-xl h-12 w-[120px]">
                  <SelectValue />
                </SelectTrigger>
                      ...
                      <SelectItem key={account.id} value={account.id} className="hover:glass-strong">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-muted-foreground text-xs ml-auto">
                            {formatCurrency(account.balance, settings?.defaultCurrency || 'INR')}
                          </span>
                        </div>
                      </SelectItem>
                    );
